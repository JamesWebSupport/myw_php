...
<span>
    ...
    @if (Auth::user())
        ...
        @else
            <a class="btn btn-success btn-sm" href="{{ route('like', ['post', $post->id])}}"><i class="fas fa-thumbs-up"></i></a>
        @endif
        <!-- Create Comment -->
    ...
    @if (Auth::user() == $post->user)
        ...
        <span><a class="btn btn-warning btn-sm" href="{{route('delete_post', $post->id)}}"><i class="fas fa-trash"></i></a></span>
    @endif
</span>
</div>
